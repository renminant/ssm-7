	...
	<div class="optitle clearfix">
		...
		<div class="content">
			...
			<tr>
				...
				<td><input type="text" name="number" class="text" id="number" value="<c:out value="${user.number}"></c:out>"> <font color="red">*</font><font color="red" id="loginName_span"></font></td>
			</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" name="tel" class="text" id="tel" value="<c:out value="${user.tel}"></c:out>"> <font color="red">*</font><font color="red" id="phone_span"></font></td>
